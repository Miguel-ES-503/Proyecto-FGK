            ...
            // Pasamos los parametros para la inserción de datos
                ...
                for($i=0;$i <= 10 ;$i++) {
                  ...
                  $consulta3=$pdo->prepare("INSERT INTO usuarios(nombre,correo,contrasena,ID_Sede,cargo,SedeAsistencia,imagen) VALUES(:nombre,:correo,:contra,:sede,:cargo,:asi,:imagen)");
                    ...
                    $header = "Este correo electrónico ha sido generado automaticamente, por favor no responda a este correo.
                    Hola ". $Nombre. " queremos darte  la noticia que te han inscrito a una plataforma  llamada  Workeys Oportunidades la cual podrá acceder en la siguiente  URL  http://www.workeysoportunidades.org/";
