...
$varLugar = $_SESSION['Lugar'];
 	...
 	if (isset($_POST['ActualizarReunion'])) 
 	{
		...
		$consulta=$pdo->prepare("UPDATE reuniones SET Titulo=:Titulo , Fecha = :Fecha , ID_Empresa = :ID_Empresa ,  ID_Ciclo = :ID_Ciclo , Estado = :Estado , Tipo = :Tipo  WHERE ID_Reunion =:id");
