...
<div class="container-fluid text-center">
   ...
   <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    ...
    <!-- Navbar brand -->
    <a class="navbar-brand" href="#">Reportes De Competencias</a>
...
<div class="collapse navbar-collapse" id="basicExampleNav">
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
            <a class="nav-link" href="ReporteCompetenciasFecha.php">Fecha</a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link active" href="ReporteCompetenciasCiclo.php">Ciclo</a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="ReporteCompetenciasTrimestre.php">Por Trimestre</a>
        </li>
    </ul>
    <!-- Links -->   
</div>
        ...
        <div class="dropdown">
            ...
            <div class="card" style="margin: 3%;">
                <div class="card-header">
                    <p style="font-size: 25px; color: black;"> Lista de competencias <?php  //echo $ubicacion ?></p>
                </div>
                <div class="card-body">
