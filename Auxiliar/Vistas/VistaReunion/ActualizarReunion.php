...
if (isset($_GET['id'])) {
  ...
  $consulta=$pdo->prepare("SELECT ID_Reunion,Titulo,Fecha,emp.Nombre AS 'Universidad',emp.ID_Empresa,ID_Ciclo,Estado,reu.Tipo FROM reuniones reu INNER JOIN empresas emp on reu.ID_Empresa = emp.ID_Empresa WHERE ID_Reunion = :ID_Reunion ");
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="card-body px-lg-5 pt-0" >
      ...
      <form action="../../Modelo/ModeloReunion/ActualizarReunion.php" method="POST" accept-charset="utf-8">
        ...
        <div class="form-row">
         <div class="col">
          <div class="md-form">
            <input type="text" id="NombreReunion" value="<?php echo $TituloReunion ?>" name="NombreReunion" class="form-control" placeholder="Nombre de la reunión">
        ...
        <div class="col">
          <!-- Last name -->
          <div class="md-form">
            <input type="date" id="fecha" name="fecha" value="<?php echo $Fecha ?>" class="form-control" placeholder="Nombre Completo">
          ...
          <div class="col">
            ...
            <div class="md-form">
              <select id="idempresa" name="idempresa" class="form-control">
                <option value="<?php echo $IDUniversidad ?>" selected ><?php echo $Universidad ?></option>
                <?php     
         ...
         <div class="col">
          <div class="md-form">
             <select type="text" id="tipo" name="tipo" class="form-control">
                ...
                <option value="Prueba" >Datos Pendientes</option>
    ...
    <input class="btn btn-light btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit" name="ActualizarReunion" value="Actualizar Reunión" id="Actualizar_Reunion">
          <hr>
        </form>
        <!-- Fin del Formulario -->
