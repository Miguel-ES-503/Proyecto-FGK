...
<div class="title">
  <a href="javascript:history.back();" ><img src="../img/back.png" class="icon"></a>
    ...
    <h2 class="main-title" >Aprobar / Reprobar Módulo A1</h2>
</div>

<!-- <div class="btn" >
<a href="listadogeneral5.php" ><button class="btn btn-warning" id="button">Listado general 5</button></a>
</div> -->
...
<b>
        ...
        <li><a id="menuu" class="nav-link active pg-0"  href="modulo5.php" style="background-color:#BE0032; color:white;">A1</a></li>
...
<div class="card-body mx-auto  h-100 bg-light " style="color:black; width:80% ">
	...
	<br class="salto">
		<span class="float-right">	
			<a href='listadogeneral5.php'><button type="button" class="btn btn-primary" class="botonresponsivo" data-toggle="modal" data-target="#exampleModal" style="border-radius: 20px;
	...
	<br class="salto">
			...
			<a href="Reportes/ReporteModulo5.php">
	...
	<br class="salto">
	     		...
	     		<a href="ReportesExcel/ReporteModulo5.php">
