...
<ul class="nav nav-tabs w-75 mx-auto">
  <li class="nav-item">
    <a class="nav-link active" href="#">Módulo C1</a>
  </li>
  <li class="nav-item">
...
<br>
<a href="Reportes/ReporteModulo1.php" class="float-left" style="margin-left: 12.5%;" target="blank"><button class="btn btn-danger"><i class="fas fa-download"></i> PDF</button></a>

  <a href="ReportesExcel/ReporteModulo1.php" class="float-left" ><button class="btn btn-success"><i class="fas fa-file-excel"></i> EXCEL</button></a>
<br><br>
