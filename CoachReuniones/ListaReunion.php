...
<div class="container-fluid">
	<?php  if ($consulta->rowCount() >=0) {$fila=$consulta->fetch() ?>
		<blockquote class="blockquote text-center">
			...
			<footer class="blockquote-footer mb-3" style="color: white; font-size: 20px;">Tipo de reunión: <cite title="Source Title"><?php echo $fila['Tipo']; ?></cite></footer>
		</blockquote>
		<hr>
		<br>
		...
		<div class="modal-body">
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				...
				<li class="nav-item">
					...
					aria-selected="false">Inscritos</a>
				</li>
