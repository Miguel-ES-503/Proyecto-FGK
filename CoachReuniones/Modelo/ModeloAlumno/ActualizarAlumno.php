...
if (isset($_POST['Guardar_Datos']))
{
   ...
   echo $buscadorIDMail;
		...
		}else
		{
			...
			for($i=0;$i <= 10 ;$i++) {
				...
				$password .= substr($str,rand(0,62),1);
				    ...
				    $header = "Este correo electrónico ha sido generado automaticamente, por favor no responda a este correo. Hola ".$PrimerNombre[0]." queremos darte  la noticia que se ha actualizado tu contraseña la cual podrá acceder en la siguiente  URL  http://www.workeysoportunidades.org/";
	...
	//Consulta de actualización de datos
		$consulta=$pdo->prepare("UPDATE alumnos SET  Nombre=:Nombre , Class=:Class  , ID_Carrera=:ID_Carrera , ID_Empresa=:ID_Empresa , Sexo=:Sexo , Estado=:Estado , ID_Status=:ID_Status, SedeAsistencia=:SedeAsistencia , ID_Sede=:ID_Sede WHERE ID_Alumno = :id ");
