...
$LugarSAT=$InicialDep . $FinalDep .$Sabatino; //Ejemplo SSSAT
	...
	$consulta=$pdo->prepare("SELECT `ID_Alumno` , `Nombre` , `Class` , `ID_Sede` , Estado , TotalTalleres FROM alumnos WHERE `Estado` = 'Activo' OR `Estado` = 'Graduado'  AND SedeAsistencia =  ? OR  SedeAsistencia  =  ? ");
