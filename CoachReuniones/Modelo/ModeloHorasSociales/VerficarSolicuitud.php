...
if (isset($_POST['EnviarDato'])) 
{
	...
	$consulta=$pdo->prepare("UPDATE hsociales SET estado=:estado , comentario = :comentario, CantidadH = :CantidadH   WHERE ID_HSociales=:id");
	$consulta->bindParam(":estado",$Estado);
	$consulta->bindParam(":comentario",$Comentario);
	$consulta->bindParam(":id",$IDSolicitud);
	$consulta->bindParam(":CantidadH",$Horas);
