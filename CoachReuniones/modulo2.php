...
<a href="Reportes/ReporteModulo2.php" class="float-left" style="margin-left: 12.5%;" target="blank"><button class="btn btn-danger"><i class="fas fa-download"></i> PDF</button></a>

   <a href="ReportesExcel/ReporteModulo2.php" class="float-left" ><button class="btn btn-success"><i class="fas fa-file-excel"></i> EXCEL</button></a>
<br><br>
<!-- Inicio de tabla de asistencia  -->
    <div class="card-body w-75 mx-auto ">
      <div class="table-responsive">
        <form action="Aprobartodos2.php" method="POST">
