...
<br><br><br>
<div class="btn" >
<a href="listadogeneral3.php" ><button class="btn btn-warning" id="button">Listado general 3</button></a>
</div>
<br><br>
...
<div class="table-responsive-sm" id="nav1">
  <table cellpadding="10" align="center">
    ...
    <tr>
       <td><a class="nav-link ml-2" href="modulo3.php" style="width: 80px;font-size: 10px;background-color:#BE0032; color:white;" id="btn-h">Módulo B1</a></td>
...
<a class="nav-link" href="modulo2.php">Módulo C2</a>
  <a class="nav-link" href="modulo3.php" style="background-color:#BE0032; color:white;">Módulo B1</a>
