...
<div class="table-responsive-sm" id="nav1">
  <table cellpadding="10" align="center">
    ...
    <tr>
     ...
     <td><a class="nav-link ml-2" href="modulo4.php" style="width: 80px;font-size: 10px;background-color:#BE0032; color:white;" id="btn-h">Modulo B2</a></td>
    </tr>
    <tr>
...
<a class="nav-link" href="modulo2.php">Módulo C2</a>
  ...
  <a class="nav-link" href="modulo4.php" style="background-color:#BE0032; color:white;">Modulo B2</a>
