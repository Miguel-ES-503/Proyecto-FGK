        ...
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            ...
            <nav class="nav flex-column " id="nav" style="height:85%">
                ...
                <button type="button" data-toggle="modal" data-target="#exampleModalLong" class="nav-link">Horarios
                    Disponibles</button>
                <button type="button" class="nav-link" role="link"
                    onclick="window.location='sessionesAsistencia.php'">Listado de asistencia</button>
                <button type="button" class="nav-link" role="link"
                    onclick="window.location='sesionesfinalizadas.php'">Sesiones finalizadas</button>
            </nav>
        </div>
        <div class="col-xs-4 w-100 col-sm-4 col-md-8 col-lg-8">
            <div class="tabla">
                <div align="right" class="h-100 w-100 botones" id="btns">
                    <a href="Reportes/ReporteSession.php" target='blank'><button class="btn btn-danger"><img
                                src="../img/pdf.png" width="30px" height="30px"><span
                                class="text">Descargar</span></button></a>
                    <a href="ReportesExcel/ReporteReuniones.php"><button class="btn btn-success"><img
                                src="../img/excell.png" width="25px" height="30px"><span
                                class="text">Descargar</span></button></a>
                </div>
                <div class="panel-body img-fluid " style=" width:95%">
                    <div id="tablapdf">
    ...
    <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content h-100 w-100 pb-5" id="contenedor5">
                ...
                <form id="regiration_form" class="float-left ml-3 p-3 w-100 contenido-center"
                    ...
                    <fieldset class="username enable text-center">
                        ...
                        <br><br><br>
                        <button type="button" class="next btn btn-info text-center">Siguiente <i
                    ...
                    <fieldset class="email enable">
                        ...
                        <br>
                        <button type="button" name="previous" class="previous btn btn-warning">Anterior <i
                                class="fas fa-arrow-circle-left"></i></button>
                        <button type="button" class="next btn btn-info">Siguiente <i
                                class="fas fa-arrow-circle-right"></i></button>
                    </fieldset>
                    ...
                    <fieldset class="thanks enable">
                        <label for="exampleInputPassword2" class="text-dark">Gracias por crear una sesion OneonOne
                        </label>
                        <br><br><br>
                        <button type="button" name="previous" class="previous btn btn-warning">Anterior <i
                                class="fas fa-arrow-circle-left"></i></button>
                        <button type="submit" class="submit btn btn-success btn1 mx-auto text-center">Crear <i
