    ...
    <div class="CabeceraComentario" style="">
        <div class="card" style="margin-top: 3%;">
            <div class="card-header">
                <p style="font-size: 25px; color: black;"><?php echo $_GET['id2']; ?></p>
            </div>
                ...
                <div class="col-sm">
                    ...
                    <div class="card" style="margin: 1%;">
                        ...
                        <div class="card-body">
                           ...
                           echo " <a href='DetallesTaller.php?id=".$id."&id2=".$id2."&id3=".$id3."&id4=".$id4."&id5=".$id5."&id6=".$_GET['id6']."'.><button type='button' class='btn btn-info'>Información</button></a></a>";
