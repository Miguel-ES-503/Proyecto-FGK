...
if (isset($_GET['id'])) {
	...
	$consulta2=$pdo->prepare("SELECT a.ID_Alumno, a.Class , a.ID_Sede , a.Nombre , T.Titulo , Asistencia ,IT.ID_Taller FROM inscripciontalleres IT INNER JOIN alumnos a on IT.ID_Alumno = a.ID_Alumno LEFT JOIN talleres T on IT.ID_Taller = T.ID_Taller  WHERE  IT.ID_Taller = ?");
						...
						<div class="card-body">
							...
							<ul class="float-left" style="text-align: left;">
								...
								if ($consulta4->rowCount()>=1)
								{
									...
									{		
										echo "<li style='color: white;'>".utf8_encode($fila4['Nombre'])."</li>";
									}
								}
								?>
							</ul>
