...
else if(isset($_POST['TitutloTaller']))
{
	if (isset($_POST['Guardar_Taller'])) 
	{
    	...
    	$IDTaller =$ciclo1.$ciclo2.$Fecha2.rand(100,999).$InicialDep.$FinalDep;
    	...
    	$consulta1=$pdo->prepare("INSERT INTO talleres(ID_Taller,Titulo,Fecha,Hora,ID_Formato,ID_Sede,ID_Ciclo,ID_Empresa,Estado,Cupo , Rating , lugar ) VALUES(:ID_Taller,:Titulo,:Fecha,:Hora,:ID_Formato,:ID_Sede,:ID_Ciclo,:ID_Empresa,:Estado,:Cupo,:Rating,:lugar)");
    	...
    	$consulta1->bindParam(':lugar',$lugar);
