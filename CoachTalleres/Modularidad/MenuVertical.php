...
<div id="page-content-wrapper">
  ...
  <nav class="navbar navbar-expand-lg border-bottom" id="menu">
    ...
    <center>
      <a href="http://portal.workeysoportunidades.org/CoachTalleres/index.php">
   ...
   <script type="text/javascript">
          ...
          if (tipo=='Desinscribirse') {
                      //Si es desinscribirse de un taller
                      if (EstadoSolicitud=='Aprobado') {
                        if (estado=='Visto') {
                          $("#notis").append('<div class="notificacion">'
                             +'<a class="dropdown-item noti" href="DetallesDesincribirTaller.php?id='+solicitud+'&&idNotif='+idNoti+'">'
                              +'<div class="row Envia">'
