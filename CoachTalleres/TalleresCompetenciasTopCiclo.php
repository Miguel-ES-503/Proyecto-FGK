    ...
    <div class="collapse navbar-collapse" id="basicExampleNav">
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                ...
                echo " <a href='ReporteCompetenciasCiclo.php'><button type='button' class='btn btn-light'>Regresar</button></a>";
        ...
        <table id="example" class="table table-responsive">
            ...
            <tbody>
                ...
                $consulta=$pdo->prepare("   SELECT A.Titulo as 'Titulo', A.Fecha as 'Fecha',S.Nombre as 'Sede',F.Nombre as 'Tipo'
                    ...
                    where T.IDComptenecia = ? AND A.ID_Ciclo = ? AND Date_Format(A.Fecha,'%Y')= ?
                    ");
                $IdC = $_GET['id'];
                $Cycle = $_GET['id2'];
                $Year = $_GET['id3'];
                ...
                $consulta->execute(array($IdC,$Cycle,$Year));
