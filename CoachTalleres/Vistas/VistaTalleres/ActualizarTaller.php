      ...
      <div class="card-body px-lg-5 pt-0" >
        ...
        <div class="form-row">
          ...
          <div class="col">
            <!-- First name   Tema , fecha , la hora y el tipo de taller -->
            <div class="md-form">
              <input type="text" value="<?php echo $lugar ?>" id="lugar" name="lugar" class="form-control">
