  ...
  ?>
    <div class="row">
        <div class="col-xs-6 col-sm-7 col-md-7 col-lg-4 h-75" id="nota">
            <strong>NOTA: </strong>
            <p>Por cuestiones de seguridad, se le pedirá su contraseña para confirmar el cambio.</p>
        </div>
    ...
    echo utf8_encode($row['titulo']);
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="fName" class="float-left text-dark">Ingrese la contraseña de su usuario
                                confirmar </label>
                            <input type="password" class="form-control" name="userpassword" id="fName"
                                placeholder="user password" required>
                        </div>
                        <input type="button" name="previous" class="previous btn btn-info" value="Previo" />
                        <button type="submit" class="btn btn-success" value="<?php echo $id ?>" name='idsave'>Guardar
                            cambios</button>
                    </fieldset>
    ...
    $(document).ready(function() {
        ...
        function coincidePassword() {
            ...
            if (valor1.length != 0 && valor1 == valor2) {
                span.text(confirmacion).removeClass("negacion").addClass(
                    'confirmacion p-1 mb-1 bg-success text-white');
            }
        }
