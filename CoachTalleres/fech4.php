...
$query = " SELECT alumnos.Nombre , one_on_one.titulo , one_on_one.estado ,one_on_one.estado_alumno, one_on_one.ID_Sede ,  one_on_one.id_alumno , one_on_one.fecha , one_on_one.hora_inicio , one_on_one.hora_fin , one_on_one.id  FROM one_on_one LEFT JOIN alumnos ON   alumnos.ID_Alumno = one_on_one.id_alumno WHERE one_on_one.estado = 'Finalizado' and (one_on_one.titulo LIKE '%$searchValue%' or one_on_one.ID_Sede LIKE '%$searchValue%' or one_on_one.fecha LIKE '%$searchValue%' or alumnos.Nombre LIKE '%$searchValue%' ) ";
...
foreach($result as $row)
{
 ...
 $sub_array[] = $row['Nombre']." "."<b>";
 $sub_array[] = utf8_encode($row['ID_Sede'])."</b>";
