...
while($fila=$consulta2->fetch())
{
	...
	$pdf->Cell(20,6,utf8_decode($fila['Class']),1,0,'C');
	$pdf->Cell(20,6,utf8_decode($fila['ID_Sede']),1,0,'C');
	$pdf->Cell(20,6,utf8_decode($fila['Sexo']),1,0,'C');
	$pdf->Cell(40,6,utf8_decode($fila['ID_Empresa']),1,0,'C');
	$pdf->Cell(70,6,utf8_decode($fila['nombre']),1,0,'L');
	$pdf->Cell(30,6,'',1,1,'L');
}
$pdf->SetFillColor(232,232,232);
$pdf->SetFont('Arial','B',12);
