...
<body class="container">
	...
	<div class="card">
		...
		<h5 class="card-header info-color white-text text-center py-4">
			<strong style="color:black;">Eliminar carrera</strong>
		</h5>
		...
		<div class="card-body px-lg-5">
			...
			<!-- Form -->
			<form class="text-center" style="color: #757575;" action="../../Modelo/ModeloCarrera/EliminarCarrera.php" method="POST">
				...
				<!-- Sign in button -->
				<button class="btn btn-outline-light  btn-rounded btn-block z-depth-0 my-4 waves-effect" type="submit">Eliminar Carrera</button>
