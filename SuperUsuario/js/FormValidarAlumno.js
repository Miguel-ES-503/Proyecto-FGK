$(document).ready(function(){
    $("#Guardar_Alumno").click(function(){
        ...
        var reg =/^([0-9]{4}([-]{1})([A-Z]{2}|[A-Z]{3})(([-]{1})(FT|SAT){1}([-]{1})[0-9]{4})$)/g; // Expresion Regular carnet
        ...
        if(!carnet ==""){
            if(reg.test(carnet))
            {
                 ...
                 {
                    document.getElementById("alerta").innerHTML = alertaInicio + " Ingrese el correo oficial oportunidades!" + alertaCierre; return false;
                 }
