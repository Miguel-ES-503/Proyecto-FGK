...
<div class="btn" >
  ...
  <a href="Reportes/ReporteModulo5.php" target="_blank" ><button class="btn btn-danger" id="button" style="border-radius: 20px;
    border: 2px solid #9d120e;
    width: 200px;height: 38px;
     background-color: #9d120e;
     color:white;"><img src="../img/PDF.png" width="25px" height="25px">Descargar</button></a>

  <a href="ReportesExcel/ReporteModulo5.php" class="float-left"  ><button class="btn btn-success" id="button" style="border-radius: 20px;
