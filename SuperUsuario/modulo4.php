...
<div class="topnav" id="myTopnav">
  ...
  <a  class="titulomenu" style="background-color:#ADADB2; color: #2D2D2E; font-size: 25px;">Aprobar/Reprobar Módulo B2 </a>
...
<b>
        ...
        <li><a id="menuu" class="nav-link active pg-0"  href="modulo4.php" style="background-color:#BE0032; color:white;">B2</a></li>
...
<div class="card-body mx-auto  h-100 bg-light " style="color:black; width:80% ">
	...
	<br class="salto">
		<span class="float-right">	
			<a href='listadogeneral4.php'><button type="button" class="btn btn-primary" class="botonresponsivo" data-toggle="modal" data-target="#exampleModal" style="border-radius: 20px;
	...
	<br class="salto">
			...
			<a href="Reportes/ReporteModulo4.php">
	...
	<br class="salto">
	     		...
	     		<a href="ReportesExcel/ReporteModulo4.php">
...
<tbody>
<?php
      require_once 'Modelo/ModeloModulos/ListadoModulos/listadomodulos4.php';
          ?>
        </tbody>
      </table>
</form>
