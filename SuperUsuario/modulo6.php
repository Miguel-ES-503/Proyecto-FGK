...
<div class="topnav" id="myTopnav">
  ...
  <a  class="titulomenu" style="background-color:#ADADB2; color: #2D2D2E; font-size: 25px;">Aprobar / Reprobar Módulo A2</a>
...
<div class="card-body mx-auto  h-100 bg-light " style="color:black; width:80% ">
	...
	<br class="salto">
		<span class="float-right">	
			<a href='listadogeneral6.php'><button type="button" class="btn btn-primary" class="botonresponsivo" data-toggle="modal" data-target="#exampleModal" style="border-radius: 20px;
