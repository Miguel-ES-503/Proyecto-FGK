...
<div class="container-fluid text-center">
    ...
    <div class="row">
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 nav">
            ...
            <nav class="nav flex-column menu-responsive" id="nav" style="height:85%">
                ...
                <button type="button" id="sesion" class="nav-link" role="link"
    ...
    width: 150px;height: 38px;
     ...
     color:white;"><img src="../img/excell.png" width="25px" height="30px"><span
                                class="text">Descargar</span></button></a>
                </div>
        ...
        <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered ">
                <div class="modal-content h-100 w-100 pb-5" id="contenedor5">
                    ...
                    <form id="regiration_form" class="float-left ml-3 p-3 w-100"
                        action="<?php echo $_SERVER['PHP_SELF']; ?>" Method="POST">
                        <br>

                        <fieldset class="username enable text-center">
                            <label for="exampleInputEmail1" class="text-dark">Seleccione el encargado de la
                                sesión</label>
                        ...
                        <fieldset class="password2 enable">
                            <label for="exampleInputPassword1" class="text-dark">Hora de finalización de la sesión:
                            </label>
