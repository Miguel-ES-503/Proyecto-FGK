...
<div class="card">
	...
	<textarea class="form-control" name="comentario" id="exampleFormControlTextarea3" rows="7" placeholder="Escriba el objetivo del taller... 300 caracteres maximo" minlength="1" maxlength="300" required><?php echo $DetalleObjetivo; ?></textarea>
		</div>
