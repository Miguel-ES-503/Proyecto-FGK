      ...
      <div class="form-row">
          <div class="col">
            ...
            <div class="md-form">
                ...
                {
                  echo " <a href='../ComproTalleres/$Comprobante' class='btn btn-success px-3 far fa-file-alt'> </a><br>";
                }
              ?>
