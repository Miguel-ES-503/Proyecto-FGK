<?php 
 ...
 if (isset($_POST['Actualizar_Taller'])) {
 	...
 	//Declaración de variables
		...
		$consulta=$pdo->prepare("UPDATE talleres SET Titulo=:Titulo , Fecha =:Fecha , Hora =:Hora , ID_Formato = :ID_Formato , ID_Sede = :ID_Sede , ID_Ciclo = :ID_Ciclo , ID_Empresa = :ID_Empresa , Estado = :Estado , Cupo = :Cupo  WHERE  ID_Taller = :ID_Taller");
