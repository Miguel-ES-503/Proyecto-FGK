...
?>
    ...
    <div class="card" style="margin: 3%;">
        <div class="card-header">
            <p style="font-size: 25px;"> Lista de talleres asistidos por alumnos <?php  //echo $ubicacion ?></p>
        </div>
        <div class="card-header">
            <p style="font-size: 25px; text-align:  left; display: inline-block;margin-right:  15px;">Cambiar estado a
                graduado:</p>
            <button type="button" class="btn btn-info" onclick="UpdateEstado();" style="">Cambiar</button>

            <p style="font-size: 25px; text-align:  left; display: inline-block;margin-left:   25px;">Seleccionar todos:
            </p>
