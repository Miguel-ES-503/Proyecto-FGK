...
$pdf->Image('Recursos/logo_oportunidades.png',215, 20, 70, 20, 'png');
 ...
 $pdf->Cell(40);
$pdf->Cell(30,6,utf8_decode('Nombre Taller: '),0,0,'L',1);
$pdf->Cell(1);
$pdf->Cell(35,6,utf8_decode($TituloTaller),0,0,'L',1);
$pdf->Ln(6);
$pdf->Cell(40);
$pdf->Cell(10,6,utf8_decode('Tipo:'),0,0,'L',1);
$pdf->Cell(1);
$pdf->Cell(50,6,utf8_decode($Tipo),0,0,'L',1);
$pdf->Cell(13,6,utf8_decode('Lugar:'),0,0,'L',1);
$pdf->Cell(2);
$pdf->Cell(80,6,utf8_decode($Lugar),0,0,'L',1);
...
if ($consulta2->rowCount()>=1)
{
    while ($fila2=$consulta2->fetch())
    {
        ...
        $pdf->Cell(20,6,utf8_decode($fila2['Sexo']),1,0,'C');
 	    ...
 	    $pdf->Cell(70,6,utf8_decode($fila2['Carrera']),1,0,'L');
        $pdf->Cell(30,6,'',1,1,'L');
    }
}
