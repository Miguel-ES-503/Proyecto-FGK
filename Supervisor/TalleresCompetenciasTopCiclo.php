    ...
    <div class="collapse navbar-collapse" id="basicExampleNav">
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                ...
                echo " <a href='ReporteCompetenciasCiclo.php'><button type='button' class='btn btn-light' style='background-color: #D9DEDE'><div class='fas fa-angle-left' ></div>Regresar</button></a>";
